...
public class Retirement {
	...
	public double MonthlySavings() {
		...
		double pmt = Retirement.PMT(dAnnualReturnWorking, dMonthsToWork, 0, this.TotalAmountToSave(), false);
	...
	public double TotalAmountToSave() {
		...
		double pv = Retirement.PV(dMonthlyReturnRetired, iMonthsRetired, dRequiredIncome - dMonthlySSI, 0, false);
